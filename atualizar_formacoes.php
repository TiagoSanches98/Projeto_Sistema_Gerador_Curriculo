    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      <ul class="nav navbar-nav d-flex justify-content-end" id="links">
        ...
        <li class="nav-item active">
          <a class="nav-link text-dark" href="atualizar_formacoes.php">Atualizar</a>
        </li>
        <li class="nav-item">
...
<div class="teste container-fluid text-center">
    ...
    <form action="atualizar_formacoes.php" method="POST">
        <div class="row">
    ...
    if(isset($_POST['bt_pesquisar_atualizar'])){
            ...
            if($_POST['nome_curso'] == "" && $_POST['instituicao'] == ""){
              ...
              while($dados = mysqli_fetch_array($resultado)){
                  ...
                  <td>$situacao</td>
                  <td>$valor</td>
                  <td><a class='btn btn-primary' href='editar_formacoes.php?id=$idformacoes'>Editar</a></td>
                </tr>";
              } 
            }
    }
