...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    ...
    <a class="navbar-brand" href="#"><?= $_SESSION['nome']?> - Consultar Experiências</a>
    ...
    <form action="consultar_formacoes.php" method="POST">
        <div class="row">
            <div class="col-6 mt-2">
                <input type="text" name="nome_curso" id="nome_curso" class="form-control" placeholder="Nome da Empresa">
                <div class="invalid-feedback">
                Digite o nome da empresa
                </div>
            </div>
            <div class="col-6 mt-2">
                <input type="text" name="instituicao" id="instituicao" class="form-control" placeholder="Cargo">
                <div class="invalid-feedback">
                Digite o cargo
                </div>
            </div>
            <div class="col-6 mt-2">
                <input type="text" name="nivel" id="nivel" class="form-control" placeholder="Tempo de serviço">
                <div class="invalid-feedback">
                Digite o tempo de serviço na empresa
                </div>
            </div>
